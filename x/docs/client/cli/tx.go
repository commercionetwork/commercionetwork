...
func getCmdShareDocument(cdc *codec.Codec) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return getCmdShareDocumentFunc(cmd, args, cdc)
		},
	}
...
func getCmdShareDocumentFunc(cmd *cobra.Command, args []string, cdc *codec.Codec) error {
...
func getCmdSendDocumentReceipt(cdc *codec.Codec) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return getCmdSendDocumentReceiptFunc(cmd, args, cdc)
		},
	}
...
func getCmdSendDocumentReceiptFunc(cmd *cobra.Command, args []string, cdc *codec.Codec) error {
	cliCtx := context.NewCLIContext().WithCodec(cdc)
	txBldr := auth.NewTxBuilderFromCLI().WithTxEncoder(utils.GetTxEncoder(cdc))
