...
func (k Keeper) NewPosition(ctx sdk.Context, depositor sdk.AccAddress, deposit sdk.Coin) error {
	...
	cdp := types.NewPosition(depositor, deposit, credits, ctx.BlockHeight())
