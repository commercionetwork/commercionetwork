...
func TestAppModuleBasic(t *testing.T) {
	...
	require.Equal(t, `{"positions":[],"pool_amount":[],"collateral_rate":"1.000000000000000000","freeze_period":"1814400000000000"}`, string(amb.DefaultGenesis()))

	require.Panics(t, func() { amb.ValidateGenesis(json.RawMessage(`{}`)) })
	require.NoError(t, amb.ValidateGenesis(json.RawMessage(`{"positions":[],"pool_amount":[],"collateral_rate":"1.000000000000000000","freeze_period":"1814400000000000"}`)))
