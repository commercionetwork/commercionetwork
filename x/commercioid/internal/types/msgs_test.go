...
func TestMsgSetIdentity_GetSignBytes(t *testing.T) {
	expected := `{"type":"commercioid/SetIdentity","value":{"did_document_uri":"https://test.example.com/did-document#1","owner":"cosmos1lwmppctrr6ssnrmuyzu554dzf50apkfvd53jx0"}}`
