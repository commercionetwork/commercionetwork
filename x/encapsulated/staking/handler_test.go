...
func TestValidatorByPowerIndex(t *testing.T) {
	...
	// create validator
	msgCreateValidator := staking.NewTestMsgCreateValidator(validatorAddr, keep.PKs[0], initBond)
	...
	msgCreateValidator = staking.NewTestMsgCreateValidator(validatorAddr3, keep.PKs[2], initBond)
	res, err = handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
...
func TestDuplicatesMsgCreateValidator(t *testing.T) {
	...
	msgCreateValidator1 := staking.NewTestMsgCreateValidator(addr1, pk1, valTokens)
	...
	assert.Equal(t, staking.Description{}, validator.Description)

	// two validators can't have the same operator address
	msgCreateValidator2 := staking.NewTestMsgCreateValidator(addr1, pk2, valTokens)
	res, err = handleMsgCreateValidator(ctx, msgCreateValidator2, keeper)
	require.Error(t, err)
	require.Nil(t, res)

	// two validators can't have the same pubkey
	msgCreateValidator3 := staking.NewTestMsgCreateValidator(addr2, pk1, valTokens)
	res, err = handleMsgCreateValidator(ctx, msgCreateValidator3, keeper)
	require.Error(t, err)
	require.Nil(t, res)

	// must have different pubkey and operator
	msgCreateValidator4 := staking.NewTestMsgCreateValidator(addr2, pk2, valTokens)
...
func TestInvalidPubKeyTypeMsgCreateValidator(t *testing.T) {
	...
	msgCreateValidator := staking.NewTestMsgCreateValidator(addr, invalidPk, sdk.NewInt(10))
	res, err := handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.Error(t, err)
	require.Nil(t, res)
...
func TestLegacyValidatorDelegations(t *testing.T) {
	...
	// create validator
	msgCreateVal := staking.NewTestMsgCreateValidator(valAddr, valConsPubKey, bondAmount)
	...
	msgDelegate := staking.NewTestMsgDelegate(delAddr, valAddr, bondAmount)
	...
	msgSelfDelegate := staking.NewTestMsgDelegate(sdk.AccAddress(valAddr), valAddr, bondAmount)
...
func TestIncrementsMsgDelegate(t *testing.T) {
	...
	msgCreateValidator := staking.NewTestMsgCreateValidator(validatorAddr, keep.PKs[0], bondAmount)
	res, err := handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgDelegate := staking.NewTestMsgDelegate(delegatorAddr, validatorAddr, bondAmount)
...
func TestEditValidatorDecreaseMinSelfDelegation(t *testing.T) {
	...
	msgEditValidator := staking.NewMsgEditValidator(validatorAddr, staking.Description{}, nil, &newMinSelfDelegation)
...
func TestIncrementsMsgUnbond(t *testing.T) {
	...
	msgDelegate := staking.NewTestMsgDelegate(delegatorAddr, validatorAddr, initBond)
	res, err = handleMsgDelegate(ctx, msgDelegate, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
...
func TestMultipleMsgCreateValidator(t *testing.T) {
	...
	for i, validatorAddr := range validatorAddrs {
		valTokens := sdk.TokensFromConsensusPower(10)
		msgCreateValidatorOnBehalfOf := staking.NewTestMsgCreateValidator(validatorAddr, keep.PKs[i], valTokens)
	...
	for i, validatorAddr := range validatorAddrs {
		...
		msgUndelegate := staking.NewMsgUndelegate(delegatorAddrs[i], validatorAddr, unbondAmt) // remove delegation
		res, err := handleMsgUndelegate(ctx, msgUndelegate, keeper)
		require.NoError(t, err)
		require.NotNil(t, res)
		...
		staking.EndBlocker(ctx.WithBlockTime(blockTime.Add(params.UnbondingTime)), keeper)
...
func TestMultipleMsgDelegate(t *testing.T) {
	...
	msgCreateValidator := staking.NewTestMsgCreateValidator(validatorAddr, keep.PKs[0], sdk.NewInt(10))
	res, err := handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	for _, delegatorAddr := range delegatorAddrs {
		msgDelegate := staking.NewTestMsgDelegate(delegatorAddr, validatorAddr, sdk.NewInt(10))
		res, err := handleMsgDelegate(ctx, msgDelegate, keeper)
		require.NoError(t, err)
		require.NotNil(t, res)
...
func TestJailValidator(t *testing.T) {
	...
	unbondAmt := sdk.NewCoin(sdk.DefaultBondDenom, sdk.NewInt(10))
	msgUndelegateValidator := staking.NewMsgUndelegate(sdk.AccAddress(validatorAddr), validatorAddr, unbondAmt)
...
func TestValidatorQueue(t *testing.T) {
	...
	// create the validator
	valTokens := sdk.TokensFromConsensusPower(10)
	msgCreateValidator := staking.NewTestMsgCreateValidator(validatorAddr, keep.PKs[0], valTokens)
	res, err := handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgDelegate := staking.NewTestMsgDelegate(delegatorAddr, validatorAddr, delTokens)
	res, err = handleMsgDelegate(ctx, msgDelegate, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
...
func TestRedelegationPeriod(t *testing.T) {
	...
	msgCreateValidator = staking.NewTestMsgCreateValidator(validatorAddr2, keep.PKs[1], sdk.NewInt(10))
	res, err = handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgBeginRedelegate := staking.NewMsgBeginRedelegate(sdk.AccAddress(validatorAddr), validatorAddr, validatorAddr2, redAmt)
...
func TestTransitiveRedelegation(t *testing.T) {
	...
	msgCreateValidator = staking.NewTestMsgCreateValidator(validatorAddr3, keep.PKs[2], sdk.NewInt(10))
	res, err = handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgBeginRedelegate = staking.NewMsgBeginRedelegate(sdk.AccAddress(validatorAddr), validatorAddr2, validatorAddr3, redAmt)
	res, err = handleMsgBeginRedelegate(ctx, msgBeginRedelegate, keeper)
	require.Error(t, err)
	require.Nil(t, res)
...
func TestMultipleRedelegationAtSameTime(t *testing.T) {
	...
	// create the validators
	valTokens := sdk.TokensFromConsensusPower(10)
	msgCreateValidator := staking.NewTestMsgCreateValidator(valAddr, keep.PKs[0], valTokens)
	res, err := handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)

	msgCreateValidator = staking.NewTestMsgCreateValidator(valAddr2, keep.PKs[1], valTokens)
	res, err = handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgBeginRedelegate := staking.NewMsgBeginRedelegate(selfDelAddr, valAddr, valAddr2, redAmt)
	res, err = handleMsgBeginRedelegate(ctx, msgBeginRedelegate, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
...
func TestUnbondingWhenExcessValidators(t *testing.T) {
	...
	msgCreateValidator := staking.NewTestMsgCreateValidator(validatorAddr1, keep.PKs[0], valTokens1)
	res, err := handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgCreateValidator = staking.NewTestMsgCreateValidator(validatorAddr2, keep.PKs[1], valTokens2)
	res, err = handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgCreateValidator = staking.NewTestMsgCreateValidator(validatorAddr3, keep.PKs[2], valTokens3)
	res, err = handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgUndelegate := staking.NewMsgUndelegate(sdk.AccAddress(validatorAddr2), validatorAddr2, unbondAmt)
	res, err = handleMsgUndelegate(ctx, msgUndelegate, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
...
func TestBondUnbondRedelegateSlashTwice(t *testing.T) {
	...
	valTokens := sdk.TokensFromConsensusPower(10)
	msgCreateValidator := staking.NewTestMsgCreateValidator(valA, keep.PKs[0], valTokens)
	res, err := handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)

	msgCreateValidator = staking.NewTestMsgCreateValidator(valB, keep.PKs[1], valTokens)
	res, err = handleMsgCreateValidator(ctx, msgCreateValidator, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)

	// delegate 10 stake
	msgDelegate := staking.NewTestMsgDelegate(del, valA, valTokens)
	res, err = handleMsgDelegate(ctx, msgDelegate, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgUndelegate := staking.NewMsgUndelegate(del, valA, unbondAmt)
	res, err = handleMsgUndelegate(ctx, msgUndelegate, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
	...
	msgBeginRedelegate := staking.NewMsgBeginRedelegate(del, valA, valB, redAmt)
	res, err = handleMsgBeginRedelegate(ctx, msgBeginRedelegate, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
...
func TestInvalidCoinDenom(t *testing.T) {
	...
	msgCreate := types.NewMsgCreateValidator(valA, keep.PKs[0], invalidCoin, staking.Description{}, commission, sdk.OneInt())
	res, err := handleMsgCreateValidator(ctx, msgCreate, keeper)
	require.Error(t, err)
	require.Nil(t, res)

	msgCreate = types.NewMsgCreateValidator(valA, keep.PKs[0], validCoin, staking.Description{}, commission, sdk.OneInt())
	res, err = handleMsgCreateValidator(ctx, msgCreate, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)

	msgCreate = types.NewMsgCreateValidator(valB, keep.PKs[1], validCoin, staking.Description{}, commission, sdk.OneInt())
	res, err = handleMsgCreateValidator(ctx, msgCreate, keeper)
	require.NoError(t, err)
	require.NotNil(t, res)
