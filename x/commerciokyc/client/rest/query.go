...
func RegisterRoutes(cliCtx client.Context, r *mux.Router) {
	...
	r.HandleFunc("/commercionetwork/commerciokyc/invites", getInvitesHandler(cliCtx)).Methods("GET")
	r.HandleFunc("/commercionetwork/commerciokyc/tsps", getTrustedServiceProvidersHandler(cliCtx)).Methods("GET")
	r.HandleFunc("/commercionetwork/commerciokyc/memberships", getMemberships(cliCtx)).Methods("GET")
	r.HandleFunc(fmt.Sprintf("/commercionetwork/commerciokyc/membership/{%s}", restParamAddress),
		getMembershipForAddr(cliCtx)).Methods("GET")
	r.HandleFunc(fmt.Sprintf("/commercionetwork/commerciokyc/sold/{%s}", restParamTsp),
