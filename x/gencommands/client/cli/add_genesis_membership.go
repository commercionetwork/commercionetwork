...
func AddGenesisMembershipCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		...
		RunE: func(cm *cobra.Command, args []string) error {
			return addGenesisMembershipCmdFunc(cm, args, ctx, cdc)
		},
	}
...
func addGenesisMembershipCmdFunc(_ *cobra.Command, args []string, ctx *server.Context, cdc *codec.Codec) error {
	config := ctx.Config
