...
2. Validators of the Rebus Hub vote on the proposal using `MsgVote` and proposal passes
...
2. Validators of the Rebuschain vote on the proposal using `MsgVote` and proposal passes
...
- There shouldn't exist any native Cosmos Coin ERC20 Contract (eg Rebus, Atom,
