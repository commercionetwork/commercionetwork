...
// source: commercionetwork/erc20/erc20.proto
...
func (Owner) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_df553e2e039cc01c, []int{0}
}
...
type TokenPair struct {
	...
	ContractOwner Owner `protobuf:"varint,4,opt,name=contract_owner,json=contractOwner,proto3,enum=commercionetwork.commercionetwork.erc20.Owner" json:"contract_owner,omitempty"`
}
...
func (*RegisterCoinProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_df553e2e039cc01c, []int{1}
}
...
func (*RegisterERC20Proposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_df553e2e039cc01c, []int{2}
}
...
func (*ToggleTokenConversionProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_df553e2e039cc01c, []int{3}
}
...
func init() {
	proto.RegisterEnum("commercionetwork.commercionetwork.erc20.Owner", Owner_name, Owner_value)
	proto.RegisterType((*TokenPair)(nil), "commercionetwork.commercionetwork.erc20.TokenPair")
	proto.RegisterType((*RegisterCoinProposal)(nil), "commercionetwork.commercionetwork.erc20.RegisterCoinProposal")
	proto.RegisterType((*RegisterERC20Proposal)(nil), "commercionetwork.commercionetwork.erc20.RegisterERC20Proposal")
	proto.RegisterType((*ToggleTokenConversionProposal)(nil), "commercionetwork.commercionetwork.erc20.ToggleTokenConversionProposal")
}

func init() {
	proto.RegisterFile("commercionetwork/erc20/erc20.proto", fileDescriptor_df553e2e039cc01c)
}

var fileDescriptor_df553e2e039cc01c = []byte{
	// 486 bytes of a gzipped FileDescriptorProto
	,
}
