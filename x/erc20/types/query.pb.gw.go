...
var (
	...
	pattern_Query_TokenPair_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"commercionetwork", "erc20", "token_pair", "token"}, "", runtime.AssumeColonVerbOpt(true)))
