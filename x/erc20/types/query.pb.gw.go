...
var (
	pattern_Query_TokenPairs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"commercionetwork", "erc20", "token_pairs"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_TokenPair_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"commercionetwork", "erc20", "token_pairs", "token"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"commercionetwork", "erc20", "params"}, "", runtime.AssumeColonVerbOpt(true)))
)
