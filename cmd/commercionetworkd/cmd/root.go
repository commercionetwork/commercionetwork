...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithBroadcastMode(config.DefaultConfig().BroadcastMode).
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			serverCtx, err := server.InterceptConfigsAndCreateContext(cmd, customTemplate, customCommercioConfig, customCMTConfig)
			if err != nil {
				return err
			}
