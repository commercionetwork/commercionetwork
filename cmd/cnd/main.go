...
func main() {
	...
	rootCmd.AddCommand(gencmds.SetGenesisVbrPoolAmountCmd(ctx, cdc, app.DefaultNodeHome, app.DefaultCLIHome))
	...
	rootCmd.AddCommand(gencmds.AddGenesisMembershipCmd(ctx, cdc, app.DefaultNodeHome, app.DefaultCLIHome))
